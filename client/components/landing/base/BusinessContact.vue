...
import BaseAvatarCard from "./AvatarCard";
    ...
    business: [
      {
        ...
        title: "Address",
        text: "4700 Keele St<br>Toronto, ON M3J 1P3",
      },
      {
        icon: "mdi-cellphone",
        title: "Phone",
        text: "1 (800) 888 777<br>1 (800) 888 666",
      },
      {
        icon: "mdi-email",
        title: "Email",
        text: "dev@audify.com<br>dev2@audify.com",
      },
    ],
  }),
};
